...
import java.nio.file.Paths;
  ...
  String alphabetFolder;
  String outputFile;  
  
  protected int chars_per_line=15;
...
void Generator() {
  ...
  alphabetFolder = dataPath("") + "/ALPHABET/";
  outputFile = dataPath("") + "/" + "TEMP.NGC"; 
  
  //message = SplitForLength("Hi\n");
  message = messageArea.getTextAsArray();  
  println(message[0]);
  
  println(LongestLine(message));
  
  TextCreateMessageNow(message[0]);
